...
createConnection().then(async connection=>{
    ...
    const permission_types=['view_user','edit_user','view_roles','edit_roles','view_teams','edit_teams','view_goals','edit_goals','edit_departments','view_departments']//defines the types of the permissions 
